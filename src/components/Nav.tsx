...
const Nav = () => {
    ...
    return (
        <nav className="relative mx-8 md:mx-16 lg:mx-32 mb-24 flex items-center justify-between pb-6 pt-12 font-medium">
            <svg
            ...
            >
                ...
                <motion.div className="hidden items-center gap-12 xl:flex">
                    <img src={dribble} alt="Dribbble Account" />
                    <img src={twitter} alt="Twitter Account" />
                    <img src={youtube} alt="Youtube Account" />
                </motion.div>
            </motion.div>
